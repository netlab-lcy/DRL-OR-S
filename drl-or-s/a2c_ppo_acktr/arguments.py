...
def get_args():
    ...
    parser.add_argument('--recurrent-policy', action='store_true', default=False,
                        help='use a recurrent policy') # DRL-OR-S do not support recurrent-policy
    ...
    parser.add_argument('--env-name', default='Abi',
                        help='environment to train on (default: Abi)') 
    ...
    parser.add_argument("--demand-matrix", default='TM.txt', 
                        help='demand matrix input file name (default:test.txt)') # deprecated 
    ...
    parser.add_argument('--use-mininet', action='store_true', default=False,
                        help='Whether using NN-simulator or mininet for training')
    ...
    assert args.algo in ['ppo'] # DRL-OR-S only support PPO
