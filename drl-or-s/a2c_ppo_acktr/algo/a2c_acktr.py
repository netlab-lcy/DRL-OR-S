'''
We do not update a2c algorithm for DRL-OR-S
TODO: update a2c algorithm to make DRL-OR-S support a2c
'''
import torch
...
class A2C_ACKTR():
    ...
    def update(self, rollouts):
        ...
        action_loss = -(masks * advantages.detach() * action_log_probs).mean()
